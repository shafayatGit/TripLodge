      ...
      <div className="w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-scroll mt-4">
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr className="">
              <th className="px-3 py-3 text-gray-800 font-medium">Name</th>
              <th className="px-3 py-3 text-gray-800 font-medium max-sm:hidden">
                Facility
              </th>
              <th className="px-3 py-3 text-gray-800 font-medium">
                Price / night
              </th>
              <th className="px-3 py-3 text-gray-800 font-medium">Actions</th>
            </tr>
          </thead>
