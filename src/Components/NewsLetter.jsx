...
const NewsLetter = () => {
  return (
    <div className="flex flex-col items-center w-full max-w-6xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
      <div className="flex flex-col justify-center items-center text-center">
        <h1 className="text-4xl md:text-[40px] play">Stay With tripLodge</h1>
      </div>
